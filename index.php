            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                ...
                <div class="bhoechie-tab-content">
                    <center>
                        ...
                        <iframe height="500px" width="100%" src="http://localhost/bitm_b35_ajit/labexam8_ajitdas_143229_b35_update_delete/views/SEIP143229/Birthday/index.php" name="iframe_b"></iframe>
                    </center>
                </div>
                <!-- City section -->
                <div class="bhoechie-tab-content">
                ...
                <div class="bhoechie-tab-content">
                    <center>
                        <div>Book Title</div>
                        <iframe height="500px" width="100%" src="http://localhost/bitm_b35_ajit/labexam8_ajitdas_143229_b35_update_delete/views/SEIP143229/BookTitle/index.php" name="iframe_f"></iframe>
                    </center>
                </div>
                <!-- flight section -->
                <div class="bhoechie-tab-content">
